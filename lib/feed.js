...
// ── Create post ───────────────────────────────────────────────────────────────
export async function createPost({ sellerId, title, description, price, origPrice, category, condition, brand, location, isNegotiable, deliveryAvailable, isHot = false, emoji, tags = [], mediaFiles = [], filterName = 'Original', musicTrackId = null, musicStartSec = 0, status = 'active' }) {
  // Upload media first
  const imageUrls = []
  let   videoUrl  = null
